...
I also figured because of the bigger countries having more people, I would make a graph that adjusts for the earnings per player in each country so its fairer for each country. After doing this, I ended up with this graph:\
![Graph 1.b](https://github.com/Stat184-Spring2026/Sec4_CP_Isabella_Adam/blob/main/images/projectgraph2.png?raw=true){width="80%"}\

Alt text: This graph represents the highest earning countries per player. At the very top, we have China at \$35,000. Then it goes down being Denmark, Korea, Ukraine, Sweden, and then more. As can be seen, the top countries change a decent amount when comparing top countries when divided by the amount of players. Specifically, the European countries tend to jump up quite a bit. They have less players competing overall, but in the games that they do indeed compete in, they tend to be extremely successful in. China is still in the top due to their success in almost every time of game, and the top tends to be dominated by Asia and Europe in almost every type of games.
