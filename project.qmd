...
The second analysis I've decided to do is a stacked bar chart of the top 10 games per country, looking specifically at the top 3 countries (China, United States, Korea). I took the data from eSportsearnings, which shows top games per country.

![](images/clipboard-1006556325.png){width="255"}

![](images/clipboard-251021042.png){width="409"}
